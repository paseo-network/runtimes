...
impl<T: frame_system::Config> runtime_parachains::disputes::slashing::WeightInfo for WeightInfo<T> {
	...
	fn report_dispute_lost(n: u32, ) -> Weight {
		...
		//  Measured:  `5927 + n * (184 ±0)`
		//  Estimated: `9243 + n * (185 ±0)`
		// Minimum execution time: 98_357_000 picoseconds.
		Weight::from_parts(197_909_260, 0)
			.saturating_add(Weight::from_parts(0, 9243))
			// Standard Error: 3_843
			.saturating_add(Weight::from_parts(393_100, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(16))
			.saturating_add(T::DbWeight::get().writes(9))
			.saturating_add(Weight::from_parts(0, 185).saturating_mul(n.into()))
	}
}
