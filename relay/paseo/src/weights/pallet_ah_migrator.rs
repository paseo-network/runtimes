...
// pallet
// --runtime
// ./target/production/wbuild/asset-hub-paseo-runtime/asset_hub_paseo_runtime.wasm
// --extrinsic
// 
// --pallet
// pallet_ah_migrator
...
impl<T: crate::ah_migration::weights::DbConfig> pallet_rc_migrator::weights_ah::WeightInfo for WeightInfo<T> {
	...
	fn receive_liquid_accounts(n: u32, ) -> Weight {
		...
		Weight::from_parts(37_207_495, 0)
			.saturating_add(Weight::from_parts(0, 990))
	...
	fn receive_proxy_announcements(n: u32, ) -> Weight {
		...
		Weight::from_parts(18_577_444, 0)
			.saturating_add(Weight::from_parts(0, 990))
	...
	fn receive_bags_list_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(55_395_537, 0)
			.saturating_add(Weight::from_parts(0, 1489))
	...
	fn receive_crowdloan_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(18_891_502, 0)
			.saturating_add(Weight::from_parts(0, 990))
	...
	fn receive_staking_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(19_203_490, 0)
			.saturating_add(Weight::from_parts(0, 0))
