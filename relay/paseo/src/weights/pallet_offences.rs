...
impl<T: frame_system::Config> pallet_offences::WeightInfo for WeightInfo<T> {
	...
	fn report_offence_grandpa(_n: u32, ) -> Weight {
		...
		//  Estimated: `45173`
		// Minimum execution time: 147_656_000 picoseconds.
		Weight::from_parts(393_467_000, 0)
	...
	fn report_offence_babe(_n: u32, ) -> Weight {
		...
		//  Measured:  `1271 + n * (52 ±0)`
		//  Estimated: `45173`
		// Minimum execution time: 147_327_000 picoseconds.
		Weight::from_parts(374_162_000, 0)
			.saturating_add(Weight::from_parts(0, 45173))
			.saturating_add(T::DbWeight::get().reads(63))
			.saturating_add(T::DbWeight::get().writes(54))
	}
