...
impl<T: frame_system::Config> pallet_offences::WeightInfo for WeightInfo<T> {
	...
	fn report_offence_grandpa(n: u32, ) -> Weight {
		...
		//  Measured:  `1484 + n * (39 ±0)`
		//  Estimated: `4948 + n * (2551 ±0)`
		// Minimum execution time: 92_844_000 picoseconds.
		Weight::from_parts(112_420_426, 0)
			.saturating_add(Weight::from_parts(0, 4948))
			// Standard Error: 211_862
			.saturating_add(Weight::from_parts(19_612_911, 0).saturating_mul(n.into()))
	...
	fn report_offence_babe(n: u32, ) -> Weight {
		...
		//  Measured:  `1484 + n * (39 ±0)`
		//  Estimated: `4948 + n * (2551 ±0)`
		// Minimum execution time: 94_697_000 picoseconds.
		Weight::from_parts(128_210_631, 0)
			.saturating_add(Weight::from_parts(0, 4948))
			// Standard Error: 196_608
			.saturating_add(Weight::from_parts(17_229_601, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(15))
			.saturating_add(T::DbWeight::get().reads((3_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(6))
			.saturating_add(T::DbWeight::get().writes((3_u64).saturating_mul(n.into())))
