...
impl<T: frame_system::Config> pallet_offences::WeightInfo for WeightInfo<T> {
	...
	fn report_offence_grandpa(n: u32, ) -> Weight {
		...
		//  Measured:  `1099`
		//  Estimated: `4549 + n * (2551 ±0)`
		// Minimum execution time: 61_810_000 picoseconds.
		Weight::from_parts(65_173_811, 0)
			.saturating_add(Weight::from_parts(0, 4549))
			// Standard Error: 9_420
			.saturating_add(Weight::from_parts(11_772_604, 0).saturating_mul(n.into()))
	...
	fn report_offence_babe(n: u32, ) -> Weight {
		...
		Weight::from_parts(64_492_122, 0)
			.saturating_add(Weight::from_parts(0, 4549))
			// Standard Error: 9_618
			.saturating_add(Weight::from_parts(11_786_004, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(12))
			.saturating_add(T::DbWeight::get().reads((3_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(7))
			.saturating_add(T::DbWeight::get().writes((3_u64).saturating_mul(n.into())))
