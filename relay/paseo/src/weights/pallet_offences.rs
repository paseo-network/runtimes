...
impl<T: frame_system::Config> pallet_offences::WeightInfo for WeightInfo<T> {
	...
	fn report_offence_grandpa(n: u32, ) -> Weight {
		...
		// Minimum execution time: 69_103_000 picoseconds.
		Weight::from_parts(73_427_173, 0)
			.saturating_add(Weight::from_parts(0, 5520))
			// Standard Error: 114_433
			.saturating_add(Weight::from_parts(12_336_123, 0).saturating_mul(n.into()))
	...
	fn report_offence_babe(n: u32, ) -> Weight {
		...
		//  Measured:  `1926 + n * (60 ±0)`
		//  Estimated: `5520 + n * (2551 ±0)`
		// Minimum execution time: 70_757_000 picoseconds.
		Weight::from_parts(86_912_702, 0)
			.saturating_add(Weight::from_parts(0, 5520))
			// Standard Error: 76_883
			.saturating_add(Weight::from_parts(10_370_008, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(19))
			.saturating_add(T::DbWeight::get().reads((3_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(13))
			.saturating_add(T::DbWeight::get().writes((3_u64).saturating_mul(n.into())))
