...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1646 + c * (15993 ±0) + h * (86 ±0) + u * (32862 ±0)`
		//  Estimated: `13810 + c * (15993 ±0) + h * (3103 ±0) + u * (32862 ±0)`
		// Minimum execution time: 800_520_000 picoseconds.
		Weight::from_parts(559_083_666, 0)
			.saturating_add(Weight::from_parts(0, 13810))
			// Standard Error: 112_701_658
			.saturating_add(Weight::from_parts(353_460_333, 0).saturating_mul(u.into()))
			// Standard Error: 112_701_658
			.saturating_add(Weight::from_parts(303_697_333, 0).saturating_mul(h.into()))
			...
			.saturating_add(Weight::from_parts(0, 15993).saturating_mul(c.into()))
			.saturating_add(Weight::from_parts(0, 3103).saturating_mul(h.into()))
			.saturating_add(Weight::from_parts(0, 32862).saturating_mul(u.into()))
	}
}
