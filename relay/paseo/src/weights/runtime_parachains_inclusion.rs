...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1634 + c * (15993 ±0) + h * (92 ±0) + u * (65724 ±0)`
		//  Estimated: `52185181060393248 + c * (17748 ±0) + h * (15130 ±0) + u * (41539 ±0)`
		// Minimum execution time: 653_627_000 picoseconds.
		Weight::from_parts(178_088_633, 0)
			.saturating_add(Weight::from_parts(0, 52185181060393248))
			// Standard Error: 4_192_423
			.saturating_add(Weight::from_parts(256_992_472, 0).saturating_mul(u.into()))
			// Standard Error: 4_192_423
			.saturating_add(Weight::from_parts(307_991_668, 0).saturating_mul(h.into()))
			// Standard Error: 6_947_345
			.saturating_add(Weight::from_parts(94_503_415, 0).saturating_mul(c.into()))
			...
			.saturating_add(Weight::from_parts(0, 15130).saturating_mul(h.into()))
			.saturating_add(Weight::from_parts(0, 41539).saturating_mul(u.into()))
	}
}
