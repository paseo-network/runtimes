...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn receive_upward_messages(i: u32, ) -> Weight {
		...
		//  Measured:  `65761`
		//  Estimated: `69051`
		// Minimum execution time: 106_111_000 picoseconds.
		Weight::from_parts(120_935_420, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 320_713
			.saturating_add(Weight::from_parts(102_377_976, 0).saturating_mul(i.into()))
