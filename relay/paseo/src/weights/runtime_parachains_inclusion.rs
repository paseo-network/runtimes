...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 760_415_000 picoseconds.
		Weight::from_parts(189_951_666, 0)
			.saturating_add(Weight::from_parts(0, 13810))
			// Standard Error: 97_460_310
			.saturating_add(Weight::from_parts(351_442_333, 0).saturating_mul(u.into()))
			// Standard Error: 97_460_310
			.saturating_add(Weight::from_parts(387_264_833, 0).saturating_mul(h.into()))
