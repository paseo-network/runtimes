...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1509 + c * (15993 ±0) + h * (92 ±0) + u * (65724 ±0)`
		//  Estimated: `69051 + c * (17748 ±507) + h * (15058 ±681) + u * (41475 ±681)`
		// Minimum execution time: 631_080_000 picoseconds.
		Weight::from_parts(121_888_638, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 1_754_128
			.saturating_add(Weight::from_parts(254_298_738, 0).saturating_mul(u.into()))
			// Standard Error: 1_754_128
			.saturating_add(Weight::from_parts(314_046_871, 0).saturating_mul(h.into()))
			// Standard Error: 2_906_799
			.saturating_add(Weight::from_parts(79_584_717, 0).saturating_mul(c.into()))
			...
			.saturating_add(Weight::from_parts(0, 15058).saturating_mul(h.into()))
			.saturating_add(Weight::from_parts(0, 41475).saturating_mul(u.into()))
	}
}
