...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1539 + c * (15992 ±0) + h * (92 ±0) + u * (65723 ±0)`
		//  Estimated: `69051 + c * (17748 ±492) + h * (15057 ±0) + u * (41474 ±267)`
		// Minimum execution time: 570_604_000 picoseconds.
		Weight::from_parts(149_241_060, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 550_794
			.saturating_add(Weight::from_parts(202_814_455, 0).saturating_mul(u.into()))
			// Standard Error: 550_794
			.saturating_add(Weight::from_parts(244_329_331, 0).saturating_mul(h.into()))
			// Standard Error: 912_732
			.saturating_add(Weight::from_parts(34_086_055, 0).saturating_mul(c.into()))
