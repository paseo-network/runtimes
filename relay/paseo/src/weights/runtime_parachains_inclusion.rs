...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn receive_upward_messages(i: u32, ) -> Weight {
		...
		//  Measured:  `65761`
		//  Estimated: `69051`
		// Minimum execution time: 137_610_000 picoseconds.
		Weight::from_parts(146_970_000, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 116_303
			.saturating_add(Weight::from_parts(122_019_644, 0).saturating_mul(i.into()))
