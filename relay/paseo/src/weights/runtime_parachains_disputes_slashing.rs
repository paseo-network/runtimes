...
impl<T: frame_system::Config> runtime_parachains::disputes::slashing::WeightInfo for WeightInfo<T> {
	...
	fn report_dispute_lost_unsigned(n: u32, ) -> Weight {
		...
		//  Measured:  `2316 + n * (32 ±0)`
		//  Estimated: `5730 + n * (33 ±0)`
		// Minimum execution time: 127_763_000 picoseconds.
		Weight::from_parts(163_084_668, 0)
			.saturating_add(Weight::from_parts(0, 5730))
			// Standard Error: 2_075
			.saturating_add(Weight::from_parts(144_503, 0).saturating_mul(n.into()))
