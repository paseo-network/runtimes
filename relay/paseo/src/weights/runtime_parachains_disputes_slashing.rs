...
impl<T: frame_system::Config> runtime_parachains::disputes::slashing::WeightInfo for WeightInfo<T> {
	...
	fn report_dispute_lost_unsigned(n: u32, ) -> Weight {
		...
		//  Measured:  `2396 + n * (32 ±0)`
		//  Estimated: `5815 + n * (33 ±0)`
		// Minimum execution time: 156_633_000 picoseconds.
		Weight::from_parts(254_148_258, 0)
			.saturating_add(Weight::from_parts(0, 5815))
			// Standard Error: 5_033
			.saturating_add(Weight::from_parts(149_222, 0).saturating_mul(n.into()))
