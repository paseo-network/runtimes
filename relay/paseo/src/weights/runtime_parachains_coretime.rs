...
impl<T: frame_system::Config> runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `2848`
		//  Estimated: `6313`
		// Minimum execution time: 104_940_000 picoseconds.
		Weight::from_parts(105_691_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(19_794_906, 0)
			.saturating_add(Weight::from_parts(0, 3579))
			// Standard Error: 220
			.saturating_add(Weight::from_parts(8_216, 0).saturating_mul(s.into()))
