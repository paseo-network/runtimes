...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn submit_finality_proof(p: u32, v: u32, ) -> Weight {
		...
		//  Measured:  `31 + p * (60 ±0)`
		//  Estimated: `51735`
		// Minimum execution time: 589_387_000 picoseconds.
		Weight::from_parts(610_024_000, 0)
			.saturating_add(Weight::from_parts(0, 51735))
			// Standard Error: 323_886
			.saturating_add(Weight::from_parts(64_899_420, 0).saturating_mul(p.into()))
			// Standard Error: 500_908
			.saturating_add(Weight::from_parts(5_409_802, 0).saturating_mul(v.into()))
	...
	fn force_set_pallet_state() -> Weight {
		...
		Weight::from_parts(193_633_000, 0)
			.saturating_add(Weight::from_parts(0, 51735))
