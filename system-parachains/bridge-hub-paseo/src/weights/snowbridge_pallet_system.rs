...
impl<T: frame_system::Config> snowbridge_pallet_system::WeightInfo for WeightInfo<T> {
	...
	fn upgrade() -> Weight {
		...
		Weight::from_parts(65_843_000, 0)
	...
	fn set_operating_mode() -> Weight {
		...
		Weight::from_parts(45_205_000, 0)
			.saturating_add(Weight::from_parts(0, 3601))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	...
	fn set_pricing_parameters() -> Weight {
		...
		//  Measured:  `218`
		//  Estimated: `3601`
		// Minimum execution time: 54_973_000 picoseconds.
	...
	fn register_token() -> Weight {
		...
		//  Measured:  `256`
		//  Estimated: `4115`
		// Minimum execution time: 76_063_000 picoseconds.
		Weight::from_parts(89_348_000, 0)
