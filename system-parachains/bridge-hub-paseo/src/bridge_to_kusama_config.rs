...
parameter_types! {
	...
	pub AssetHubPolkadotParaId: cumulus_primitives_core::ParaId = paseo_runtime_constants::system_parachain::ASSET_HUB_ID.into();
...
impl XcmBlobHauler for ToBridgeHubKusamaXcmBlobHauler {
	...
	type CongestedMessage = bp_asset_hub_paseo::CongestedMessage;
	type UncongestedMessage = bp_asset_hub_paseo::UncongestedMessage;
}
...
impl UnderlyingChainProvider for BridgeHubPolkadot {
	type Chain = bp_bridge_hub_paseo::BridgeHubPaseo;
}
