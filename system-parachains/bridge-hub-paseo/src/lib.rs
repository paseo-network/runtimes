...
use testnet_parachains_constants::paseo::{
...
use paseo_runtime_constants::system_parachain::{ASSET_HUB_ID, BRIDGE_HUB_ID};
use xcm::prelude::*;
...
pub type SignedExtra = (
	...
	(
		bridge_to_westend_config::OnBridgeHubPaseoRefundBridgeHubWestendMessages,
	),
...
mod benches {
	frame_benchmarking::define_benchmarks!(
		...
		[pallet_bridge_messages, PaseoToWestend]
...
impl_runtime_apis! {
	...
	// This is exposed by BridgeHubPaseo
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn benchmark_metadata(extra: bool) -> (
			...
			type PaseoToWestend = pallet_bridge_messages::benchmarking::Pallet ::<Runtime, bridge_to_westend_config::WithBridgeHubWestendMessagesInstance>;
		...
		fn dispatch_benchmark(
			...
			impl pallet_xcm_benchmarks::generic::Config for Runtime {
				...
				fn export_message_origin_and_destination(
					...
					Ok(
						(
							bridge_to_westend_config::FromAssetHubPaseoToAssetHubWestendRoute::get().location,
							NetworkId::Westend,
	...
	fn ensure_signed_extension_definition_is_compatible_with_relay() {
		...
		sp_io::TestExternalities::default().execute_with(|| {
			...
			let payload: SignedExtra = (
				...
				BridgeRejectObsoleteHeadersAndMessages,
				(
					bridge_to_westend_config::OnBridgeHubPaseoRefundBridgeHubWestendMessages::default(),
				),
			...
			// for BridgeHubPaseo
			{
				let bhr_indirect_payload = bp_bridge_hub_paseo::SignedExtension::from_params(
