...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for WeightInfo<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(13_575_167, 0)
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(35_147_874, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 349
			.saturating_add(Weight::from_parts(81_434, 0).saturating_mul(s.into()))
			// Standard Error: 3
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(19_703_120, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 260
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(37_672_150, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 378
			.saturating_add(Weight::from_parts(104_915, 0).saturating_mul(s.into()))
			// Standard Error: 3
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(33_241_107, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 456
			.saturating_add(Weight::from_parts(85_264, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(18_501_749, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 333
			.saturating_add(Weight::from_parts(80_028, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(33_660_144, 0)
			.saturating_add(Weight::from_parts(0, 6811))
			// Standard Error: 507
			.saturating_add(Weight::from_parts(86_011, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
