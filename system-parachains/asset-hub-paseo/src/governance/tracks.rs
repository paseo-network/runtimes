...
const TRACKS_DATA: [pallet_referenda::Track<u16, Balance, BlockNumber>; 16] = [
	pallet_referenda::Track {
		...
		info: pallet_referenda::TrackInfo {
			...
			confirm_period: 24 * RC_HOURS,
			min_enactment_period: 24 * RC_HOURS,
	...
	pallet_referenda::Track {
		...
		info: pallet_referenda::TrackInfo {
			...
			prepare_period: RC_MINUTES,
			decision_period: 7 * RC_DAYS,
			confirm_period: 10 * RC_MINUTES,
			min_enactment_period: RC_MINUTES,
	...
	pallet_referenda::Track {
		...
		info: pallet_referenda::TrackInfo {
			...
			prepare_period: 10 * RC_MINUTES,
			decision_period: 7 * RC_DAYS,
			confirm_period: RC_HOURS,
			min_enactment_period: 10 * RC_MINUTES,
