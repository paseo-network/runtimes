...
//!
//! DATABASE: `InMemoryDb`, RUNTIME: `Paseo Asset Hub`
...
//   1
//   --base-path
//   /opt/local-ssd/paseo-asset-hub/
//   --chain
//   cumulus/paseo-parachain/chain-specs/asset-hub-paseo.json
//   --detailed-log-output
//   --enable-trie-cache
//   --trie-cache-size
//   10737418240
...
/// Storage DB weights for the `Paseo Asset Hub` runtime and `InMemoryDb`.
pub mod constants {
