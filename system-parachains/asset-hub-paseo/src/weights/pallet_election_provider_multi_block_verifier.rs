...
impl<T: frame_system::Config> pallet_election_provider_multi_block::verifier::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize_valid_non_terminal() -> Weight {
		...
		//  Measured:  `353411`
		//  Estimated: `361826`
		// Minimum execution time: 2_145_223_000 picoseconds.
		Weight::from_parts(2_375_374_000, 0)
			.saturating_add(Weight::from_parts(0, 361826))
	...
	fn on_initialize_valid_terminal() -> Weight {
		...
		//  Measured:  `605073`
		//  Estimated: `687738`
		// Minimum execution time: 10_354_294_000 picoseconds.
		Weight::from_parts(11_411_145_000, 0)
			.saturating_add(Weight::from_parts(0, 687738))
	...
	fn on_initialize_invalid_terminal() -> Weight {
		...
		//  Measured:  `606094`
		//  Estimated: `688759`
		// Minimum execution time: 10_718_457_000 picoseconds.
		Weight::from_parts(11_819_200_000, 0)
			.saturating_add(Weight::from_parts(0, 688759))
	...
	fn on_initialize_invalid_non_terminal(v: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `441003 + v * (82 ±0)`
		//  Estimated: `510500 + v * (2232 ±144)`
		// Minimum execution time: 1_246_177_000 picoseconds.
		Weight::from_parts(1_594_613_407, 0)
			.saturating_add(Weight::from_parts(0, 510500))
			// Standard Error: 541_805
			.saturating_add(Weight::from_parts(4_095_409, 0).saturating_mul(v.into()))
