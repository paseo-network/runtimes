...
//! HOSTNAME: `cfc39b477cd2`, CPU: `QEMU Virtual CPU version 2.5+`
...
// --output=./system-parachains/bulletin-paseo/src/weights
...
impl<T: frame_system::Config> pallet_balances::WeightInfo for WeightInfo<T> {
	...
	fn transfer_keep_alive() -> Weight {
		...
		Weight::from_parts(33_974_000, 0)
			.saturating_add(Weight::from_parts(0, 3593))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn upgrade_accounts(u: u32, ) -> Weight {
		...
		Weight::from_parts(14_447_000, 0)
			...
			.saturating_add(Weight::from_parts(12_327_671, 0).saturating_mul(u.into()))
